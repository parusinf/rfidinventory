...
namespace ru.nikitin.RFIDInventory
{
    ...
    public static class Tools
    {
        ...
        /// Generation of beeps.
        /// </summary>
        /// <param name="beepType">Beep type</param>
        [DllImport("coredll.dll", SetLastError = true)]
        public static extern void MessageBeep(BeepType beepType);

        /// <summary>
        /// Start up folder ends \
        /// </summary>
        ...
        { 
            get 
            { 
                return String.Format("{0:HH:mm:ss}", DateTime.Now).Replace(".", ":"); 
            } 
        }
